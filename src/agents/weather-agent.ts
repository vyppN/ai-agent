...
export class WeatherAgent {
    ...
    private messages = [
        {
            role: 'system',
            content: 'You are a weather agent that provides weather and aqi information. Only use functions you have been provided with.'
        }
    ]
    ...
    askQuestion = async (message: string): Promise<string> => {
        ...
        while (iterations < MAX_ITERATIONS) {
            ...
            if (finish_reason === 'tool_calls') {
                ...
                if(functionName === 'translateThaiCityNameToEnglish') {
